...
<body>
  ...
  <div id="loginForm" class="modal">
	<form class="modal-content" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
	  ...
	  <!--Login Submit Button-->
	  <div class="input-group">
		<button type="submit" class="w3-button w3-round w3-green w3-ripple" name="login_patient">Login</button>
	  </div>
  ...
  <div id="signupForm" class="modal">
	...
	<div class="input-group">
  	  ...
  	  <input type="number" name="ssn" placeholder="xxxxxxxxx" min="100000000" max="999999999">
  	</div>
	<div class="input-group">
	...
	<!--Register Submit Button-->
  	<div class="input-group">
  	  <button type="submit" class="w3-button w3-round w3-green w3-ripple" name="reg_patient">Register</button>
	</div>
